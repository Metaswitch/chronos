...
Chronos is designed to scale out horizontally to handle large loads on the system and also supports elastic, lossless scaling up and down of the cluster to handle extra load on the service.  See [here](doc/technical.md) for a more detailed discussion of how Chronos works and [here](doc/resynchronization.md) for a more detailed discussion on how Chronos resynchronizes its timers during scaling. 
