...
TARGET_SOURCES_BUILD := main.cpp snmp_infinite_timer_count_table.cpp snmp_counter_table.cpp snmp_continuous_accumulator_table.cpp
TARGET_SOURCES_TEST := $(notdir $(wildcard src/test/*.cpp)) test_interposer.cpp fakelogger.cpp mock_sas.cpp fakecurl.cpp pthread_cond_var_helper.cpp
