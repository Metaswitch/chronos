...
# Special extra objects for chronos_test
${BUILD_DIR}/bin/chronos_test : ${chronos_test_OBJECT_DIR}/curl_interposer.so

# Build rule for our interposer.
${chronos_test_OBJECT_DIR}/curl_interposer.so : modules/cpp-common/test_utils/curl_interposer.cpp modules/cpp-common/test_utils/curl_interposer.hpp modules/cpp-common/test_utils/fakecurl.hpp modules/cpp-common/test_utils/fakecurl.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(chronos_test_CPPFLAGS) -shared -fPIC -ldl $< -o $@
CLEANS += ${chronos_test_OBJECT_DIR}/curl_interposer.so
