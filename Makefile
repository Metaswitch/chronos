...
TARGET_SOURCES += log.cpp logger.cpp unique.cpp signalhandler.cpp signalnames.cpp
...
LDFLAGS := -L${INSTALL_DIR}/lib -lrt -lpthread -lcurl -levent -lboost_program_options -lboost_regex -lc
LDFLAGS_BUILD :=
